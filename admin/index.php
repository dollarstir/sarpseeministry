    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">NEW EVENT  FORM</h4></center>
        </div>
              ...
              <div class="form-body">
                <div class="row">
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="title" placeholder="Event title">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="venue" placeholder="Place of event">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="nationality" placeholder="nationality">
                  </div> -->
                  ...
                  <div class="col-md-8 form-group">
                    <input type="date" id="first-name" class="form-control" name="edate" placeholder="Date of event">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="time" id="first-name" class="form-control" name="etime" placeholder="time for event">
                  </div>
