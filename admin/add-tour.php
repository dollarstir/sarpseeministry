    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">SERMON FORM</h4></center>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form class="form form-horizontal" id="sermonfrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                    <label>Name of Sermon</label>
                  </div>
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="title" placeholder="">
                  </div>
                  <!-- <div class="col-md-4">
                    <label>Email</label>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="contact-info" class="form-control" name="madeby" placeholder="">
                  </div>
                  <div class="col-md-4">
                    <label>Picture of Sermon</label>
                  </div>
                  <div class="col-md-8 form-group">
                  ...
                  <div class="col-md-4">
                    <label>Audio of Sermon</label>
                  </div>
                  <div class="col-md-8 form-group">
                  <div class="custom-file">
                        <input type="file" class="custom-file-input" id="inputGroupFile01" name="audio" accept="audio/*">
                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                      </div>
                  </div>
